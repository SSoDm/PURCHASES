...
Teams.Get("Blue").Properties.Get("Deaths").Value = "<b><color=Red>ПОКУПКИ</color> от BOSSa!!!</b>";
Teams.Get("Red").Properties.Get("Deaths").Value = "<b><color=red>Создал</color> BOSS!!!</b>";
